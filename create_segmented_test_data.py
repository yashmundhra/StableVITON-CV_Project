...
# Train images
copy_relevant_test_files("train", "train_segment", images_ids)  # from each subfolder in test

src_folder = "train_masks"
dest_folder_mask = "train_segment/agnostic-mask"
dest_folder_non_mask = "train_segment/agnostic-v3.2"
